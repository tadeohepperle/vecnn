...
hnsw_n = thesis_exp("hnsw_effect_of_n").filter("model", "SliceS2HnswParams").sort_by("n").discard_cols(["build_ndc", "ndc"]).with_build_ms_per_n()
hnsw_n.print()
...
# plt.yticks([i/100 for i in range(40,51,10)])
# plt.xlabel("$ef_{Construction}$")
# plt.ylabel("Search time (ms)")
...
# plt.yticks([i/1000 for i in range(940,951,2)])
